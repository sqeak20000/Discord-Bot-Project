...
async def setup_moderation_commands(bot):
    """Compatibility wrapper: keep the moderation module API stable while the real command registrations live in the commands package."""
    from commands.moderation_commands import register_moderation_commands
